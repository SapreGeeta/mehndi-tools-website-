...
function SignUp() {
  ...
  return (
    <>
      ...
      <section className="form mx-3 my-4">
        <div className="container">
          <div
            className="row rounded-3 shadow form-container"
            style={{ border: "1px solid grey", backgroundColor: "#ffffff" }}
          >
            <div className="col-lg-12 pt-3 px-5">
              ...
              <form>
                ...
                <button
                  type="button"
                  className="btn btn-success my-3 px-4 d-block mx-auto"
                  onClick={signupUser}
                >
                  <b>SignUp</b>
                </button>
